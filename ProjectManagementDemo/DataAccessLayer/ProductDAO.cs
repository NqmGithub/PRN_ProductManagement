...
namespace DataAccessLayer
{
    public class productsDAO
    {
        ...
        public productsDAO()
        {
            ...
            // Product uncle new Product(7, "Uncle Bob's Organic Dried Pears", 7, 22, 30); / //Product northwoods new Product (8, "Northwoods Cranberry Sauce", 2, 10, 40);
            //Product mishi new Product (9, "Mishi Kobe Niku", 6, 12, 97);
            //Product ikura new Product (10, "Ikura", 8, 13, 32);
            // listProducts = new List<Product> { chai, chang, aniseed, chef, chefMix, grandmi
        }
